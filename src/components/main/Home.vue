                                ...
                                <li class="prod-i">
                                    ...
                                    <div class="prod-i-skuwrapcolor">
                                        <ul class="prod-i-skucolor">
                                            <li class="bx_active"><img src="src/assets/img/color/red.jpg" alt="Red"></li>
                                            <li><img src="src/assets/img/color/blue.jpg" alt="Blue"></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="prod-i">
                        ...
                        <div class="prod-cont">
                            ...
                            <div class="prod-skuwrap">
                                ...
                                <ul class="prod-skucolor">
                                    <li class="active">
                                        <img src="src/assets/img/color/blue.jpg" alt="">
                                    </li>
                                    <li>
                                        <img src="src/assets/img/color/red.jpg" alt="">
                                    </li>
                                    <li>
                                        <img src="src/assets/img/color/green.jpg" alt="">
                                    </li>
                                    <li>
                                        <img src="src/assets/img/color/yellow.jpg" alt="">
                                    </li>
                                    <li>
                                        <img src="src/assets/img/color/purple.jpg" alt="">
                                    </li>
                                </ul>
                    ...
                    <div class="row">
                        ...
                        <div class="stylization f-block-modal f-block-modal-map" id="f-block-modal-4">
                            <div class="allstore-gmap">
                                <div class="marker" data-zoom="15" data-lat="-37.81485261872975" data-lng="144.95655298233032" data-marker="src/assets/img/marker.png">534-540 Little Bourke St, Melbourne VIC 3000, Australia</div>
                            </div>
                        </div>
